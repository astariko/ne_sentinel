...
class BranchesControllerTest < ActionController::TestCase
  ...
  test "should create branch" do
    assert_difference('Branch.count') do
      post :create, branch: { completed: @branch.completed, http: @branch.http, name: @branch.name, root: @branch.root, user_id: @branch.user_id }
    end
  ...
  test "should update branch" do
    patch :update, id: @branch, branch: { completed: @branch.completed, http: @branch.http, name: @branch.name, root: @branch.root, user_id: @branch.user_id }
    assert_redirected_to branch_path(assigns(:branch))
  end
